        ...
        <nav class="border-b border-gray-800">
            <div class="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 py-6">
                <ul class="flex flex-col md:flex-row items-center">
                    ...
                    <x-menu-item route="movie.all" path="" text="Movies" />
                    <x-menu-item route="tv.all" path="tv" text="TV Shows" />
                    <x-menu-item route="actor.all" path="actor" text="Actors" />
    ...
    <footer class="border border-t border-gray-800">
        <center>
            <div class="container mx-auto text-sm px-4 py-6">
                ...
                <a href="https://www.themoviedb.org/documentation/api" class="underline hover:text-gray-300">
                    <b>TMDb API</b>
                </a>
            </div>
        </center>
